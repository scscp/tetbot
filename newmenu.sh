...
Exp=$(curl -sS https://raw.githubusercontent.com/scscp/tetbot/main/skkkk | grep $MYIP | awk '{print $3}')
fi
chck_b(){
...
curl -sS https://raw.githubusercontent.com/scscp/tetbot/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
