...
wget -q --no-check-certificate "https://raw.githubusercontent.com/Mahfud2128/tetbot/main//core/ssr-core.sh" -O /etc/init.d/ssrmu
...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/Mahfud2128/tetbot/main//core/ssr-core.sh"
...
Install_SSR
systemctl restart ssrmu > /dev/null 2>&1
wget -q -O /usr/bin/ssr "https://raw.githubusercontent.com/Mahfud2128/tetbot/main//shadowsocks/ssrmu.sh" && chmod +x /usr/bin/ssr
